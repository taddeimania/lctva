...
from app.views import IndexView, DashboardView, GraphView, FriendsGraphView, ExtraView, HistoryDetailView
...
urlpatterns = [
    ...
    # url(r'^history/$', ),
    url(r'^history/(?P<datestamp>\d{4}-\d{2}-\d{2})/$', HistoryDetailView.as_view(), name="history_detail_view"),
